...
toggleRepeatpasswordVisibility.addEventListener("click", function (){
    if (repeatPassord.type === "password") {
        repeatPassord.type = "text";
        toggleRepeatpasswordVisibility.classList.toggle('fa-eye-slash')
        toggleRepeatpasswordVisibility.classList.toggle('fa-eye')
    } else {
